    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='ID курса')),
                ('lesson_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='ID урока')),
